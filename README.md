...
More projects not yet posted about: [society](https://github.com/lucharo/society) (agent-to-agent communication powered by mainstream transport protocols like SSH and HTTP), [refine](https://github.com/lucharo/refine) (improve agent skills the more you use them), [eval-claude](https://github.com/lucharo/eval-claude) (daily evals on Anthropic models to monitor model degradation).
